...
/* global default_theme, default_dark_theme, default_light_theme, hljs,
 * ClipboardJS */
    ...
    fetch_with_timeout('https://play.rust-lang.org/meta/crates', {
      ...
      mode: 'cors',
        ...
        .then(response => {
          ...
          playgrounds.forEach(
              block => handle_crate_list_update(block, playground_crates));
        });
  }
      ...
      .forEach(function(pre_block) {
        ...
        if (window.playground_copyable) {
          ...
          copyCodeClipboardButton.setAttribute(
              'aria-label', copyCodeClipboardButton.title);
...
(function themes() {
  ...
  themePopup.addEventListener('focusout', function(e) {
    // e.relatedTarget is null in Safari and Firefox on macOS (see workaround
    // below)
    if (!!e.relatedTarget && !themeToggleButton.contains(e.relatedTarget) &&
...
(function controllMenu() {
  ...
  (function controllPosition() {
    ...
    // When the script loads, the page can be at any scroll (e.g. if you
    // reforesh it).
    ...
    let stickyCache =
        false;  // Same as menu.classList.contains('sticky'), but faster
